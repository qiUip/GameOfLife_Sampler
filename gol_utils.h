...
enum Engine : int { ENGINE_SIMD = 0, ENGINE_BITPACK, ENGINE_CUDA_TILE, ENGINE_CUDA_SIMPLE, ENGINE_CUDA_BITPACK, ENGINE_SIMPLE, ENGINE_HIP_SIMPLE, ENGINE_HIP_TILE, ENGINE_HIP_BITPACK };
